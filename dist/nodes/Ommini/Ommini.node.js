        ...
        for (let i = 0; i < items.length; i++) {
            ...
            try {
                ...
                // ─── GÖNDERİ ──────────────────────────────────────────
                    ...
                    const platformlar = this.getNodeParameter('gonderi_platform', i);
                    const sonuclar = [];
                    for (const platform of platformlar) {
                        ...
                        const gorsel = this.getNodeParameter('gorsel_url', i);
                        if (gorsel)
                            body.gorsel_url = gorsel;
                        const res = await this.helpers.request({
                            method: 'POST',
                ...
                // ─── VİDEO ────────────────────────────────────────────
                    ...
                    const gorevId = this.getNodeParameter('gorev_id', i);
                    const res = await this.helpers.request({
                        method: 'GET',
